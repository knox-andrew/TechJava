...
public class FilmSearchController {
    ...
    public String searchFilms(@RequestParam(defaultValue="0") int minimumLength, @RequestParam(defaultValue="1000") int maximumLength, @RequestParam String genre, ModelMap modelHolder) {
