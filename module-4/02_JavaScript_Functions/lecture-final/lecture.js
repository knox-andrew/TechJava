 ...
 * that uses that information to describe them. We join the quirks together with
 * the seperator specified or ', ' by default.
 * 
 * @param {string} name the name of the person we're describing
 * @param {number} age the age of the person 
 * @param {string[]} [listOfQuirks] a list of funny quirks 
 * @param {string} [separator=', '] string to separate the list of quirks
...
function forEachDemo() {
  ...
  myArray.forEach(function logTimesTwo(value) {console.log(value * 2)});
...
function filterDemo() {
  ...
  //return myArray.filter((n, i) => i % 2 === 0);
}
